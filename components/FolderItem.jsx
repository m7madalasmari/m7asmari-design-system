 ...
 * <FolderItem label="العمل" color="var(--sky-500)" items={24} size="2.4 غ.ب" prog={65}
...
export default function FolderItem({ label, color, items, size, prog, pinned = false, onTogglePin, showStar = false, showBar = false }) {
  ...
  return (
    <div className="dashfolder">
      ...
      {showStar ? (<i data-lucide="star" style={{ width: '14px', height: '14px', fill: 'var(--amber-400)', stroke: 'var(--amber-500)' }}></i>) : null}
