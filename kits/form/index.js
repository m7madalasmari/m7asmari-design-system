...
export const RECIPES = [
  ...
  { id: 'register', title: 'إنشاء حساب', category: 'auth', component: RegisterForm, uses: ['Field', 'Input', 'PasswordInput', 'Select', 'Checkbox', 'Button', 'Form'] },
  ...
  { id: 'wizard', title: 'تسجيل متعدّد الخطوات', category: 'advanced', component: WizardForm, uses: ['Stepper', 'Field', 'Input', 'Select', 'Button'] },
