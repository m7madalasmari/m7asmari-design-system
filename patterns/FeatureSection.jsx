...
<div className="featintro"><div className="feat-h">مزايا قويّة لمنتجك</div><p className="feat-d">اكتشف المزايا التي تجعل منصّتنا تتميّز عن غيرها — مبنية بأحدث التقنيات ومصمّمة لأقصى إنتاجية.</p><button type="button" className="arrowlink" style={css('margin-top:24px')}>احجز عرضًا<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M19 12H5M12 19l-7-7 7-7"></path></svg></button></div>
