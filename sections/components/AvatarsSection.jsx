...
<div><p className="subhead">مع حالة</p><div className="fx ac gap16"><Avatar variant="lg"><img src="assets/avatar.jpg" alt="" /><span className="stat"></span></Avatar><Avatar variant="lg" style={css('background:var(--danger)')}>د<span className="stat" style={css('background:var(--text-muted)')}></span></Avatar></div></div>
<div><p className="subhead">مجموعة</p><div className="avgroup"><Avatar variant="" title="محمد الحسمري"><img src="assets/avatar.jpg" alt="" /></Avatar><Avatar variant="" style={css('background:var(--success);color:#042c1c')} title="بدر">ب</Avatar><Avatar variant="" style={css('background:var(--warning);color:#3f2305')} title="منى">م</Avatar><Avatar variant="avmore" title="5 آخرون">5+</Avatar></div></div>
</div></ShowcasePanel>
</section>
  );
}
