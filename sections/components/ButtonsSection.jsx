...
<div className="btnrow"><Button variant="primary">متابعة<Icon name="arrow-left" /></Button><Button variant="secondary"><Icon name="download" />تنزيل</Button><Button variant="outline">محدّد</Button><Button variant="ghost">شفاف</Button><Button variant="brand">العلامة</Button><Button variant="danger">حذف</Button></div>
<span className="cap" style={css('margin-top:28px')}>الأحجام</span>
<div className="btnrow"><Button variant="primary sm">صغير</Button><Button variant="primary">متوسط</Button><Button variant="primary lg">كبير</Button><Button variant="secondary icon" aria-label="حذف"><Icon name="trash-2" /></Button><Button variant="primary icon" aria-label="متابعة"><Icon name="arrow-left" /></Button></div>
