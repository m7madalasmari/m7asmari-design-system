...
<EmptyState variant=""><span className="empty-ico" style={css('background:var(--surface-muted);color:var(--text-muted)')}>↑</span><div className="empty-title">نشاطك خالٍ</div><p className="empty-text">لا توجد معاملات لعرضها. نفّذ أول تحويل لتبدأ الحركة.</p><Button variant="secondary">إرسال عملات</Button></EmptyState>
</div>
</section>
  );
}
