...
<div><p className="subhead">حقل بحث</p><div className="search"><span className="mgicon"></span><input placeholder="ابحث عن أصل أو عنوان…" aria-label="بحث عن أصل أو عنوان" /></div></div>
