...
<div><p className="subhead">قائمة اختيار</p><div className="selectbox open" role="button" aria-haspopup="listbox" aria-expanded="true"><span>الشبكة: إيثيريوم</span><span className="chev" aria-hidden="true">▾</span></div><div className="menu" role="listbox" aria-label="اختيار الشبكة" style={css('margin-top:8px')}><div className="menuitem sel" role="option" aria-selected="true">إيثيريوم<span aria-hidden="true">✓</span></div><div className="menuitem" role="option" aria-selected="false">أربيتروم</div><div className="menuitem" role="option" aria-selected="false">أوبتيميزم</div><div className="menuitem" role="option" aria-selected="false">بوليجون</div></div></div>
